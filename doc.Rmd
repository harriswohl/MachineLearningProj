...
Any column that has more than 1900 NAs is removed, as well as features that have near zero variance. Lastly, columns such as user name, timestamp, and ID are removed since they likely have no affect on the response variable classe. 
```{r}
